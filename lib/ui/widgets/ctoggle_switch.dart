...
class CToggleSwitch extends StatefulWidget {
  ...
  @override
  _CToggleSwitchState createState() => _CToggleSwitchState();
}

class _CToggleSwitchState extends State<CToggleSwitch>
  ...
  @override
  void didUpdateWidget(CToggleSwitch oldWidget) {
