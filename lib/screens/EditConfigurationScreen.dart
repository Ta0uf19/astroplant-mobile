...
class EditConfigurationScreen extends StatefulWidget {
  @override
  _EditConfigurationScreenState createState() => _EditConfigurationScreenState();
}
                  ...
                  child: CCard(
                    ...
                    body: Column(
                      ...
                      children:[
                        Text(
                          "Description",
                          style: themeData.textTheme.subtitle1.copyWith(color : COLOR_WHITE),
                        ),
                        SizedBox(height: DEFAULT_PADDING_SMALL,),
                        Expanded(
                          child: Text(
                ...
                Container(
                  ...
                  child: CButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => EditRulesScreen()),
                      );
                    },
                  ),
                ),
